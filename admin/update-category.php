...
<div class="main-content">
    ...
    <?php 
        // check whether id set set or not
        if(isset($_GET['id']))
        {
    ...
    if(isset($_POST['submit']))
    {
        ...
        if(isset($_FILES['image']['name']))
        {
            ...
            if($image_name !="")
            {
                ...
                // rename the image
                $image_name = "Food_Category_".rand(000,999).'.'.$ext; //eg Food_Category_846.jpg
                ...
                if($current_image!="")
                {
                    ...
                    // failed to remove then display the message and stop the process
